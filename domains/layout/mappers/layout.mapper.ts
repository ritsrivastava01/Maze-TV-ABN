...
const mapHeaderNavItemsApiToViewModel = (navItems: LayoutNavApiModel[]): HeaderViewModel['headerNavItems'] => {
  return navItems
 ...
 */
export const mapHeaderNavItemsToViewModel = (navItems: LayoutNavApiModel[]): HeaderViewModel => {
  return {
