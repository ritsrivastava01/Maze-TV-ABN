import type { CastApiModel, EpisodeApiModel, ShowApiModel } from '../../tvmaze/api/tvmaze.api';
import type {
...
export const mapShowApiToShowDetailViewModel = (
  ...
  return {
    show: {
      ...
      imdbUrl: show.externals?.imdb ? `https://www.imdb.com/title/${show.externals.imdb}` : null,
    },
...
const mapEpisodeApiToViewModel = (episode: EpisodeApiModel): ShowDetailEpisodeViewModel => {
...
const mapCastApiToViewModel = (castMember: CastApiModel): ShowDetailCastMemberViewModel => {
  return {
...
const mapEpisodesToSeasons = (episodes: ShowDetailEpisodeViewModel[]): ShowDetailSeasonViewModel[] => {
