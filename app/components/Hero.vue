...
<template>
  <section
    class="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden text-white"
  >
    <img
      v-if="show"
      :src="show.heroImage"
    ...
    >
      ...
      <div v-else class="mt-auto w-full max-w-xl">
        ...
        <div
          class="mt-4 h-12 w-80 max-w-full animate-pulse rounded bg-slate-700/80 sm:h-14"
        />
